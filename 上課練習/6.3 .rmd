...
# return 只能回答一個，未來要用list才能解答多個。

# 印在螢幕，但Global Environment並不會有q_d
demand_return(1.2)
```

最近一步會使用到電腦記憶體的運算值會暫時記在：從Console中輸入.Last.value，會跑出最近一次跑的數字。
...
要避免更新global environment 而未發現導致的錯誤。方法如下
...
* 不依存於global environment 套件裡，但是又同時保有隨時更動的彈性
